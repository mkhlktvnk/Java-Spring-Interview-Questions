...
REST (Representational State Transfer) — это архитектурный стиль, в центре которого стоит ресурс, взаимодействие с которым производится с помощью методов протокола HTTP.
